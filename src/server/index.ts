...
import { devCloudflareOidc } from "./auth/dev-cloudflare-oidc";
...
import { cloudflareOidcAuth } from "./routes/v1/auth/oidc/cloudflare";
...
import { vehiclePhotos } from "./routes/v1/vehicle-photos";
...
app.route("/api/v1/_dev/oidc-cloudflare", devCloudflareOidc);
...
app.route("/api/v1/auth/oidc/cloudflare", cloudflareOidcAuth);
...
app.route("/api/v1/vehicle-photos", vehiclePhotos);
