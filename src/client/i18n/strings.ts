...
const en = {
  ...
  continueWithCloudflare: "Continue with Cloudflare",
  oidcProviderGoogle: "Google",
  oidcProviderCloudflare: "Cloudflare",
  oidcOkBanner: "Signed in with {provider}.",
  oidcErrorBanner: "{provider} sign-in didn't complete. Please try again.",
  ...
  linkCloudflareAccount: "Link Cloudflare account",
  oidcLinkedBanner: "{provider} account linked.",
  ...
  magicLinkSendFailedError: "Couldn't send the email — please try again.",
...
const ru = {
  ...
  continueWithCloudflare: "Продолжить с Cloudflare",
  oidcProviderGoogle: "Google",
  oidcProviderCloudflare: "Cloudflare",
  oidcOkBanner: "Вход выполнен через {provider}.",
  oidcErrorBanner: "Вход через {provider} не завершился. Попробуйте ещё раз.",
  ...
  linkCloudflareAccount: "Привязать аккаунт Cloudflare",
  oidcLinkedBanner: "Аккаунт {provider} привязан.",
  ...
  magicLinkSendFailedError: "Не удалось отправить письмо — попробуйте ещё раз.",
  rateLimitedError: "Слишком много попыток — подождите немного и попробуйте снова.",
